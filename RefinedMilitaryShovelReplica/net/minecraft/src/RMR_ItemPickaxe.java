...
public class RMR_ItemPickaxe extends ItemPickaxe implements RMR_IDestroyAll {
	...
	protected RMR_ItemPickaxe(int par1, EnumToolMaterial par2EnumToolMaterial) {
	...
	public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World,
		...
		par1ItemStack.itemID = toolMaterial == EnumToolMaterial.EMERALD ?
				mod_RMR_RefinedMilitaryShovelReplica.RMRAxeD.itemID :
				mod_RMR_RefinedMilitaryShovelReplica.RMRAxeI.itemID;
			...
			for (int li = 0; li < targetBlockIDs.length; li++) {
				if (targetBlockIDs[li][0] == mod_RMR_RefinedMilitaryShovelReplica.selectedblockID) {
					if (targetMetadatas[li][0] > 15 ||
						...
						byte lflag = mod_RMR_RefinedMilitaryShovelReplica.cfg_mineUnder ? RMR_DestroyData.RMR_Flag_isUnder : 0;
						RMR_DestroyData.sendMessage(0x81, par7EntityLivingBase,
								mod_RMR_RefinedMilitaryShovelReplica.cfg_mineLimit,
								lflag, par4, par5, par6, targetBlockIDs[li], targetMetadatas[li]);
						mod_RMR_RefinedMilitaryShovelReplica.Debug("Start MineAll.");
					}
				}
			}
		}
